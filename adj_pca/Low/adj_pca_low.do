...
global path "/home/timo/Documents/Adj_pca/Low"

*create log file
log using "$path/adj_pca_low.log", replace

*load the main data
use "$path/adj_pca_low.dta", clear 
...
parmest, saving(adj_pca_low_output, replace)
