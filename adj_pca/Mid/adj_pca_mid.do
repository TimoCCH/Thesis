...
global path "/home/timo/Documents/Adj_pca/Mid"

*create log file
log using "$path/adj_pca_mid.log", replace

*load the main data
use "$path/adj_pca_mid.dta", clear 
...
parmest, saving(adj_pca_mid_output, replace)
