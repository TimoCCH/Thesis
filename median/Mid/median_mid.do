...
global path "C:\Users\Chung\Desktop\EVS\Median\Mid"

*create log file
log using "$path\median_mid.log", replace

*load the main data
use "$path\median_mid.dta", clear 
...
parmest, saving(median_mid_output, replace)
