...
global path "C:\Users\Chung\Desktop\EVS\Median"

*create log file
log using "$path\median_all.log", replace

*load the main data
use "$path\median_all.dta", clear 
...
parmest, saving(median_all_output, replace)
