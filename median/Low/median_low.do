...
global path "C:\Users\Chung\Desktop\EVS\Median\Low"

*create log file
log using "$path\median_low.log", replace

*load the main data
use "$path\median_low.dta", clear 
...
parmest, saving(median_low_output, replace)
