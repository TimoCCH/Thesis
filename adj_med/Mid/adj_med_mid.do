...
global path "C:\Users\Chung\Desktop\EVS\Adj_med\Mid"

*create log file
log using "$path\adj_med_mid.log", replace

*load the main data
use "$path\adj_med_mid.dta", clear 
...
parmest, saving(adj_med_mid_output, replace)
