...
global path "C:\Users\Chung\Desktop\EVS\Adj_med"

*create log file
log using "$path\adj_med_all.log", replace

*load the main data
use "$path\adj_med_all.dta", clear 
...
parmest, saving(adj_med_all_output, replace)
