...
global path "C:\Users\Chung\Desktop\EVS\Adj_med\High"

*create log file
log using "$path\adj_med_high.log", replace

*load the main data
use "$path\adj_med_high.dta", clear 
...
parmest, saving(adj_med_high_output, replace)
